...
//            this.getSupportActionBar().hide();
        ...
        //--------below code is for showing list of project id on spinner
...
//                    Toast.makeText(SoilDataReport.this, "starting", Toast.LENGTH_SHORT).show();
                    ...
                    JsonObjectRequest jsonObjectRequest2 = new JsonObjectRequest(Request.Method.POST, url_profile_id + "?TYPE=project_profile_ID_list&projID=" + selectedProjectID, null, new Response.Listener<JSONObject>() {
                        @Override
...
//                }
        ...
        //-----------below array json is for project id from project registration table------------
...
//            if (!selectedProjectID.equals("Select Your State")) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url_projectID + "?TYPE=projectID_report&projID=" + selectedProjectID + "&projectProfileID=" + selectedProjectProfileID, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
//                        if (response.equals("success")) {
//                            progressDialog.dismiss();
...
//                        }
//                        Toast.makeText(SoilDataReport.this, "Please select Project Profile ID... !!", Toast.LENGTH_SHORT).show();
                    progressDialog.show();
                    if (response.equals("success")) {
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.putString(KEY_STATE, selectedState);
...
//            JSONArray result = jsonObject.getJSONArray("result");
            ...
            if (resultList.length() > 0) {
                for (int i = 0; i < resultList.length(); i++) {
                    ...
                    String village = resultData.getString("villagename");
...
//                    -----------------------FOR LOCATION---------------
                    ...
                    //  -----------------------FOR IMAGES---------------
                    //---------east img---------
                    String url_east_imgs = "http://14.139.123.73:9090/web/NBSS/img/"+east_image+".jpg";
...
//                    report_east_imgView.buildDrawingCache();
//                    Bitmap east_bmap = report_east_imgView.getDrawingCache();
//                    stateInfo.put("east_image", toString().valueOf(east_bmap));



                    //----------west img--------------
                    String url_west_imgs = "http://14.139.123.73:9090/web/NBSS/img/"+west_image+".jpg";
...
//                    report_west_imgView.buildDrawingCache();
//                    Bitmap west_bmap = report_west_imgView.getDrawingCache();
//                    stateInfo.put("west_image", toString().valueOf(west_bmap));

                    //-----------north img-----------
                    String url_north_imgs = "http://14.139.123.73:9090/web/NBSS/img/"+north_image+".jpg";
...
//                    report_north_imgView.buildDrawingCache();
//                    Bitmap north_bmap = report_north_imgView.getDrawingCache();
//                    stateInfo.put("north_image", toString().valueOf(north_bmap));

                    //-----------south img---------
                    String url_south_imgs = "http://14.139.123.73:9090/web/NBSS/img/"+south_image+".jpg";
...
//                    report_south_imgView.buildDrawingCache();
//                    Bitmap south_bmap = report_south_imgView.getDrawingCache();
//                    stateInfo.put("south_image", toString().valueOf(south_bmap));
